...
const App = () => {
	...
	const usersData = [
		...
		{ id: 2, name: 'Craig', username: 'siliconeidolon' , age:45 ,location:'Lucknow' },
		{ id: 3, name: 'Ben', username: 'benisphere' , age:45, location:'Chennai'},
	]
	...
	// 	location.id = users.length + 1
	// 	setUsers([ ...users, location ])
	...
	return (
		<div className="container">
			<h1 style={{color:'red'}}>CRUD App with Hooks</h1>
